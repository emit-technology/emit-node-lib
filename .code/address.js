...
function getPublicKey(privateKey) {
    ...
    var pubKey = Buffer.from(serial_1.ED_BASE.multiply(sk).toRawBytes());
...
function fromAddressBytes(addr) {
    ...
    var h1 = sign_1.blake2bHash(serial_1.EMIT_ADDR_BS_H1, Buffer.concat([new Buffer(h0_r), new Buffer(data.slice(1, 33))]));
